...
def run_test_make_simple_string():
    ...
    # Test 1:
    expected = '13-'
    actual = make_simple_string(13, 13)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    # Test 1:
    expected = '13'
    actual = make_less_simple_string(13, 13)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        circ = circles[k]
        seq = seq + [rg.Rectangle(rg.Point(circ.center.x - circ.radius, circ.center.y - circ.radius),
                                  rg.Point(circ.center.x + circ.radius, circ.center.y + circ.radius))]
    return seq
